...
def add_category_offer(request, category_id):
    ...
    return render(request, 'adminside/category/admin_category_offer.html', {
        'category': category
    })
...
def edit_category_offer(request, offer_id):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            offer.start_date = timezone.datetime.strptime(start_date, '%Y-%m-%d')
            offer.end_date = timezone.datetime.strptime(end_date, '%Y-%m-%d')
    ...
    return render(request, 'adminside/category/edit_category_offer.html', {
        'offer': offer,
        'category': category
    })
...
def toggle_category_offer(request, offer_id):
    ...
    try:
        ...
        messages.success(request, f'Offer "{offer.offer_name}" has been {status}.')
    except Exception as e:
